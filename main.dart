...
class Main extends StatelessWidget {
  int bed,bath,sqftLiving, sqftLot, floors, waterfront, view, condition, grade, sqftAbove, basement, sqftLiving15, sqftLot15;
  double lat, long; 
	    ...
	    body: Container(
          ...
          TextField(
            ...
            FlatButton(
						...
						onPressed: () async{
							var body= [
								{"bedrooms": bed, "bathrooms": bath, "sqft_living": sqftLiving, "sqft_lot": sqftLot, "floors": floors, "waterfront": waterfront, "view": view, "condition": condition, "grade": grade, "sqft_above": sqftAbove, "sqft_basement": basement, "lat": lat, "long": long, "sqft_living15": sqftLiving15, "sqft_lot15": sqftLot15}
							];
							/*body=[
...
_onBasicAlertPressed(context, resp) {
  Alert(context: context, title: "Predicted price", desc: resp)
      .show();
}